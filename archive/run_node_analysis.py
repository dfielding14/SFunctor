...
# from sfunctor.core.parallel import compute_histograms_shared  # Has API bug
from parallel_fixed import compute_histograms_shared_fixed as compute_histograms_shared
