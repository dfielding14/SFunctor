...
submit_job() {
    ...
    JOB_SCRIPT="/autofs/nccs-svm1_home2/dfielding/SFunctor/job_scripts/job_${RESOLUTION}_beta${BETA}_sw${STENCIL_WIDTH}.sh"
...
# Save submission log
LOG_FILE="/autofs/nccs-svm1_home2/dfielding/SFunctor/job_scripts/submission_log_$(date +%Y%m%d_%H%M%S).txt"
{
