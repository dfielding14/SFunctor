#!/bin/bash
# Resume wrapper script for distributed structure function analysis
# This script demonstrates how to resume a previous incomplete run

# Usage: ./resume_distributed_analysis.sh [previous_run_directory]
# 
# Example:
#   ./resume_distributed_analysis.sh /lustre/orion/ast207/proj-shared/dfielding/Production_plm/sfunctor_results/results_Turb_5120_beta25_dedt025_plm/ndisp100000_nrand10000_nell128_sw2_job12345
#
...
if [ $# -eq 1 ]; then
    ...
    BASE_RESULTS_DIR="/lustre/orion/ast207/proj-shared/dfielding/Production_plm/sfunctor_results/results_Turb_5120_beta25_dedt025_plm"
...
sbatch /autofs/nccs-svm1_home2/dfielding/SFunctor/run_distributed_analysis.sh