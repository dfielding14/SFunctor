#!/usr/bin/env bash
#SBATCH -A AST207
#SBATCH -J phase4_batch_b_all21_review
#SBATCH -o logs/phase4_batch_b_all21_review_%x_%j.out
#SBATCH -e logs/phase4_batch_b_all21_review_%x_%j.err
#SBATCH -t 00:45:00
#SBATCH -p batch
#SBATCH -N 1
...
: "${RELEASE_ROOT:?RELEASE_ROOT must be the immutable all-21 Batch B release}"
...
CLI="${SFUNCTOR_DIR}/scripts/phase4/generate_phase4_batch_b_all21_review.py"
