...
s/^LOG_DELTA_BIN_EDGES_MIN=.*/LOG_DELTA_BIN_EDGES_MIN=""/
s/^LOG_DELTA_BIN_EDGES_MAX=.*/LOG_DELTA_BIN_EDGES_MAX=""/
s/^N_DELTA_BIN_EDGES=.*/N_DELTA_BIN_EDGES=""/
...
echo "Monitor with:"
echo "  squeue -u $USER"
echo "  tail -f logs/sf_test_640_*.out"
