...
RESOLUTION="640"                    # Resolution (e.g., 5120, 10240)
BETA="25"                            # Beta value (e.g., 1, 6, 25, 100)
DEDT="025"                           # Energy injection rate
SCHEME="plm"                         # Numerical scheme

# Analysis Parameters
STENCIL_WIDTH=2                      # Stencil width (2, 3, or 5)
N_DISP_TOTAL=12500                  # Total number of displacements
N_RANDOM_SUBSAMPLES=12500          # Number of random subsamples
...
# HPC Configuration
N_NODES=2                           # Number of nodes to request
TIME_LIMIT="0:05:00"                # Wall time limit (HH:MM:SS)
...
TIME_BUFFER_MINUTES=1               # Minutes before time limit to trigger continuation
MAX_CHAIN_JOBS=3                    # Maximum number of chained jobs to prevent runaway
