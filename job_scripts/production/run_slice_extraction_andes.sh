...
# Generic slice extraction for periodic boxes on Andes.
# Usage:
#   sbatch --wait --job-name="slice_${SIM_NAME}" --export=ALL,SIM_NAME=...,FILE_NUMBER=-1 job_scripts/production/run_slice_extraction_andes.sh
