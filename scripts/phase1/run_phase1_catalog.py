#!/usr/bin/env python3
"""Build, analyze, and summarize the Phase 1 environmental catalogs."""
...
def _source_hashes() -> dict[str, str]:
    ...
    return {
        ...
        "run_phase1_catalog.py": file_sha256(scripts_dir / "run_phase1_catalog.py"),
    }
