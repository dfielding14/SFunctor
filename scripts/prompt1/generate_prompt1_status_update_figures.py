#!/usr/bin/env python3
"""Generate PROMPT1_STATUS_UPDATE.md figures from the verified Prompt 1 artifacts."""
...
DEFAULT_OUTPUT_DIR = Path("figures/prompt1_status_update")
...
def make_workflow_overview(output_dir: Path) -> Path:
    ...
    ax.text(
        0.3,
        4.05,
        "Prompt 1 primary-only census workflow (schematic)",
        fontsize=13,
        weight="bold",
    )
    ax.text(
